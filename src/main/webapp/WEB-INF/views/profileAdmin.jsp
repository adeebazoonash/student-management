        ...
        <div class="card info">
            <div class="row no-gutters">
              <div class="col-md-2"><br>
                <img src="<%= request.getContextPath() %>/resources/images/user.png"  style="height: 60%; width: 97%;" >
              </div>
              <div class="col-md-10">
                <div class="card-body">
                  <h5 class="card-title">Information</h5>
                  <p class="card-text">Name:${loggedInUser.firstName} ${loggedInUser.lastName} </p>
                  <p class="card-text">Role:  ${loggedInUser.role}</p>
                  <p class="card-text">Email: ${loggedInUser.email}</p><br>
                  <a href="http://localhost:8080/usermgmt/app/changePassword" class="btn btn-primary">Change password</a>
                  <a href="#" onclick="myFunction()" class="btn btn-info" id="btn">Edit Profile</a>
                </div>
              </div>
            </div>
        </div>
